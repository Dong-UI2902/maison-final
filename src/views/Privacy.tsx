...
import { PHONE_NUMBER } from "../Helper/Helper";

const Info = {
  title: "Chính sách bảo mật | Maison de Perfume",
  desc: "Cảm ơn bạn đã truy cập vào trang Website được vận hành bởi Maison de Perfume. Chúng tôi tôn trọng và cam kết sẽ bảo mật những thông tin mang tính riêng tư của bạn. Xin vui lòng đọc bản Chính sách bảo vệ thông tin cá nhân của người tiêu dùng dưới đây để hiểu hơn những cam kết mà chúng tôi thực hiện nhằm tôn trọng và bảo vệ quyền lợi của người truy cập. Bảo vệ thông tin cá nhân của người tiêu dùng và gây dựng được niềm tin cho bạn là vấn đề rất quan trọng với chúng tôi.",
  url: "https://maisonperfume.net/chinh-sach-bao-mat",
};
...
const Privacy = () => {
  return (
    <div className="container">
      ...
      >
        <p>
          Cảm ơn bạn đã truy cập vào trang Website được vận hành bởi Maison de
          Perfume. Chúng tôi tôn trọng và cam kết sẽ bảo mật những thông tin
          mang tính riêng tư của bạn. Xin vui lòng đọc bản Chính sách bảo vệ
          thông tin cá nhân của người tiêu dùng dưới đây để hiểu hơn những cam
          kết mà chúng tôi thực hiện nhằm tôn trọng và bảo vệ quyền lợi của
          người truy cập. Bảo vệ thông tin cá nhân của người tiêu dùng và gây
          dựng được niềm tin cho bạn là vấn đề rất quan trọng với chúng tôi. Vì
          vậy, chúng tôi sẽ dùng tên và các thông tin khác liên quan đến bạn
          tuân thủ theo nội dung của chính sách này. Chúng tôi chỉ thu thập
        ...
        <p>
          ...
          maisonperfume.net như: Họ và Tên, Địa Chỉ (nhà riêng hoặc văn phòng),
          Số Điện Thoại (di động, nhà riêng hoặc văn phòng),… Thông tin này được
        ...
        <p>
          ...
          sử dụng Website: maisonperfume.net, như các tuỳ chọn cho trang web
          hoặc thông tin về giỏ hàng điện tử của họ. Nếu không đồng ý, Khách
          Hàng có thể xoá tất cả các cookie đã nằm trong ổ cứng máy tính của
          mình bằng cách tìm kiếm các thư mục với “Cookie” trong tên của nó và
          xoá đi. Trong tương lai, Khách Hàng có thể chỉnh sửa các lựa chọn
          trong trình duyệt của mình để các Cookie (tương lai) bị chặn; Xin được
          lưu ý rằng: Nếu làm vậy, Khách Hàng có thể không sử dụng được đầy đủ
          các tính năng của Website : maisonperfume.net.
        </p>
        ...
        <p>
          Website maisonperfume.net sử dụng thông tin của Người Tiêu Dùng cung
          cấp để:
        </p>
        <p>
          ...
          Tiêu Dùng và Maison de Perfume;
          <br />
        ...
        <p>
          • Ban quản trị.
          <br />
          • Bên thứ ba có dịch vụ tích hợp với Website: maisonperfume.net
          <br />
        ...
        <p>
          • Địa chỉ: B5 Khu Beverly, P.Long Bình, TP. Thủ Đức , Tp. Hồ Chí Minh.
          <br />• Điện thoại: {PHONE_NUMBER}
          <br />• Email: Cskh@maisonperfume.net
        </p>
        <h3>6. CAM KẾT BẢO MẬT THÔNG TIN CÁ NHÂN CỦA NGƯỜI TIÊU DÙNG</h3>
        <p>
          Thông tin cá nhân của Người Tiêu Dùng trên Website maisonperfume.net
          được Ban quản trị cam kết bảo mật tuyệt đối theo chính sách bảo mật
          thông tin cá nhân được đăng tải trên Website: maisonperfume.net. Việc
          thu thập và sử dụng thông tin của mỗi Người Tiêu Dùng chỉ được thực
          hiện khi có sự đồng ý của Người Tiêu Dùng trừ những trường hợp pháp
          luật có quy định khác và quy định này.
        </p>
        <p>
        ...
        <p>
          ...
          Cskh@maisonperfume.net hoặc gọi điện thoại tới số {PHONE_NUMBER} để
          khiếu nại và cung cấp chứng cứ liên quan tới vụ việc cho Ban quản trị.
          Ban quản trị cam kết sẽ phản hồi ngay lập tức hoặc muộn nhất là trong
          vòng 24 giờ làm việc kể từ thời điểm nhận được khiếu nại.
        </p>
      </Box>
    </div>
  );
