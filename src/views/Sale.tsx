...
const Sale = () => {
  ...
  return (
    <div className="category container">
      <TagHeader
        title={"Chương Trình Ưu Đãi - Maison de Perfume"}
        desc="Cửa hàng nước hoa Nam chính hãng (Nước hoa chiết Nam) tại Maison de Perfume, chuyên bán các loại nước hoa chiết Nam, fullbox chính hãng"
        url={"https://maisonperfume.net/category/chuong-trinh-uu-dai"}
      />
      <Breadcrumb>
      ...
      <section className="category__container">
        <Box flexGrow={1} minHeight="80vh">
          ...
          <img className="sale__img" src="/assets/img/events/sale.png" />
