...
const Info = {
  title: "Cửa Hàng Nước Hoa Authentic - Maison de Perfume",
  desc: "Maisonperfume.net - Cửa hàng nước hoa chính hãng, uy tín tại TPHCM, chuyên cung cấp các sản phẩm nước hoa chính hãng với giá phù hợp.",
  url: "https://maisonperfume.net/",
};
          ...
          <Grid container spacing={{ md: 10, xs: 4 }} alignItems="center">
            <Grid item md={6} xs={12} className="about__content">
              <Fade left>
                <div>
                  <p>Giới thiệu về</p>
                  <div className="title">Maison de Perfume</div>
                </div>
                <p>
                  Bạn đang tìm kiếm điều gì ở một cửa hàng nước hoa chính hãng?
                  Những sản phẩm chính hãng? Một mùi hương khiến bạn hài lòng?
                  Hơn cả thế, <strong>Maison de Perfume</strong> sẽ mang đến cho
                  bạn những cảm xúc tuyệt vời khác cùng mùi hương.
                </p>
                <div>
                  <Button
                    component={Link}
