...
const Info = {
  title: "Chính sách đổi trả | Maison de Perfume",
  desc: "Maisonperfume.net cam kết tất cả sản phẩm maisonperfume.net bán ra đảm bảo là hàng chính hãng 100%, chúng tôi không bán hàng giả, hàng nhái, hàng không đảm bảo chất lượng... Chúng tôi phục vụ nhu cầu mua hàng trên toàn quốc với chính sách cụ thể.",
  url: "https://maisonperfume.net/chinh-sach-doi-tra",
};
  ...
  return (
    <div className="container">
      ...
      <div style={{ marginTop: "2rem" }}>
        ...
        <p>
          – Hàng hóa Maison de Perfume bán ra đảm bảo là hàng chính hãng 100%,
          chúng tôi cam kết không bán hàng giả, hàng nhái, hàng không đảm bảo
          chất lượng.
          <br />
          <br />
          ...
          phận vòi xịt, ống xịt, bị nứt, vỡ,... Maison de Perfume sẽ hỗ trợ đổi
          trả cho quý khách.
          <br />
