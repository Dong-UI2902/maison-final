    ...
    <footer id="footer">
      <div className="section footer">
        <div className="container footer__register">
          <div className="title">
            Nhận thông tin mới nhất <br /> từ Maison de Perfume
          </div>
          ...
          >
            <Grid container spacing={6} rowGap={2}>
              <Grid item xs={12} md={3.3}>
                ...
                <p>
                  Maison de Perfume - Nơi trưng bày và kinh doanh tất cả các
                  thương hiệu nước hoa trên toàn thế giới.
                </p>
              </Grid>
              ...
              <Grid item xs={12} md={3.5}>
                ...
                <UlStyle>
                  <LiStyle>
                    ...
                    <strong>Maison de Perfume</strong>
                    <br />
                    B5 Khu Beverly, P.Long Bình, TP. Thủ Đức , Tp. Hồ Chí Minh
                  </LiStyle>
                </UlStyle>
              </Grid>
              <Grid item xs={12} md={2.5}>
                ...
                <Box>
                  ...
                  >
                    <LinkStyle
                      href="mailto:cskh@maisonperfume.net"
                      underline="hover"
                    >
                      <LiStyle sx={{ textTransform: "none" }}>
                        <i className="ri-mail-line"></i>cskh@maisonperfume.net
                      </LiStyle>
                    </LinkStyle>
            ...
            >
              <p>
                Copyright © {new Date().getFullYear()} Maison de Perfume. All
                Rights Reserved.
              </p>
            </center>
          </div>
